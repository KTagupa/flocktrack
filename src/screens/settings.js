...
function SettingsTab({
  ...
  return React.createElement("div", {
  ...
  }, "Show or hide these tabs from the bottom navigation. Hiding a tab removes it from the nav only."), React.createElement("div", {
    style: {
      display: "grid",
      gap: 8
    }
    ...
    return React.createElement("div", {
      ...
      style: {
        ...
        padding: "10px 11px",
        borderRadius: 12,
        border: isVisible ? "1px solid #bfdbfe" : "1px solid #d9e3ef",
        background: isVisible ? "#eff6ff" : "#ffffff"
      }
    }, React.createElement("div", {
      style: {
        width: 34,
        ...
        border: isVisible ? "1px solid #bfdbfe" : "1px solid #e2e8f0",
        display: "grid",
        placeItems: "center",
        flexShrink: 0,
        overflow: "hidden",
    ...
    }) : tabDef.ic || "•"), React.createElement("div", {
      style: {
        minWidth: 0,
        flex: 1
      }
    ...
    }, tabDef.lbl || tabDef.label || humanize(tabDef.id)), React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#64748b",
        marginTop: 2
      }
    }, isVisible ? "Visible in bottom navigation" : "Hidden from bottom navigation")), React.createElement("button", {
      type: "button",
